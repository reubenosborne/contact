...
angular.module("app.filters").filter("initials",function(){return function(t){for(var n=t.split(" "),r=[],l=0;l<n.length;l++)r.push(n[l].charAt(0));return n.length>1?r[0]+" "+r[r.length-1]:r[0]}});
angular.module("app.filters").filter("shorten",function(){return function(n,r){return r=r||50,n.length>r?String(n).substring(0,r)+"..":n}});
